 ...
 * EmployeeTest
 *
 * Auto-generated from App\Schema\EmployeeSchema.
...
class EmployeeTest extends TestCase
{
    ...
    #[Test]
    public function it_creates_the_employees_table_from_schema_annotations(): void
    {
    ...
    {
        $this->assertSame('employees', (new Employee)->getTable());
    }

    #[Test]
    public function it_can_create_a_employee(): void
    {
        $model = Employee::create($this->createData());
    ...
    {
        return Employee::factory()->make()->toArray();
    }

    private function schemaValidate(array $data, array $ignoreUniqueFor = [], bool $skipMissing = false): MessageBag
    {
        return Employee::schemaValidate($data, $ignoreUniqueFor, $skipMissing);
    }
}
