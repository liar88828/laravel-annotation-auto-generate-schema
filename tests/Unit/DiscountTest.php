 ...
 * DiscountTest
 *
 * Auto-generated from App\Schema\DiscountSchema.
...
class DiscountTest extends TestCase
{
    ...
    #[Test]
    public function it_creates_the_discounts_table_from_schema_annotations(): void
    {
    ...
    {
        $this->assertSame('discounts', (new Discount)->getTable());
    }

    #[Test]
    public function it_can_create_a_discount(): void
    {
        $model = Discount::create($this->createData());
    ...
    {
        return Discount::factory()->make()->toArray();
    }

    private function schemaValidate(array $data, array $ignoreUniqueFor = [], bool $skipMissing = false): MessageBag
    {
        return Discount::schemaValidate($data, $ignoreUniqueFor, $skipMissing);
    }
}
