...
// NOTE: The model class name is 'Favorite' (without 'Schema' suffix).
// This import is required so PHP resolves Favorite::class to App\Models\Favorite
// and not to App\Schema\Favorite.
use App\Models\Favorite;

#[EloquentModel(model: Favorite::class)]
#[Table(name: 'favorites', timestamps: true, softDeletes: false)]
class FavoriteSchema
{
    ...
    // #[Fillable]
    // #[Required(message: 'FavoriteSchema name is required.')]
