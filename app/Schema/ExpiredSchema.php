...
// NOTE: The model class name is 'Expired' (without 'Schema' suffix).
// This import is required so PHP resolves Expired::class to App\Models\Expired
// and not to App\Schema\Expired.
use App\Models\Expired;

#[EloquentModel(model: Expired::class)]
#[Table(name: 'expireds', timestamps: true, softDeletes: false)]
class ExpiredSchema
{
    // ── Primary key ────────────────────────────────────────────────────────
    ...
    // #[Fillable]
    // #[Required(message: 'ExpiredSchema name is required.')]
