...
// NOTE: The model class name is 'Order' (without 'Schema' suffix).
// This import is required so PHP resolves Order::class to App\Models\Order
// and not to App\Schema\Order.
use App\Models\Order;

#[EloquentModel(model: Order::class)]
#[Table(name: 'orders', timestamps: true, softDeletes: false)]
class OrderSchema
{
    // ── Primary key (UUID v4) ──────────────────────────────────────────────
    ...
    #[Fillable]
    #[Required(message: 'OrderSchema name is required.')]
