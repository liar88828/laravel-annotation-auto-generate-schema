...
// NOTE: The model class name is 'Employee' (without 'Schema' suffix).
// This import is required so PHP resolves Employee::class to App\Models\Employee
// and not to App\Schema\Employee.
use App\Models\Employee;

#[EloquentModel(model: Employee::class)]
#[Table(name: 'employees', timestamps: true, softDeletes: false)]
class EmployeeSchema
{
    ...
    // #[Fillable]
    // #[Required(message: 'EmployeeSchema name is required.')]
