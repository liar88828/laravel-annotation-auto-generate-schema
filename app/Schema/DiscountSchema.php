...
// NOTE: The model class name is 'Discount' (without 'Schema' suffix).
// This import is required so PHP resolves Discount::class to App\Models\Discount
// and not to App\Schema\Discount.
use App\Models\Discount;

#[EloquentModel(model: Discount::class)]
#[Table(name: 'discounts', timestamps: true, softDeletes: false)]
class DiscountSchema
{
    ...
    // #[Fillable]
    // #[Required(message: 'DiscountSchema name is required.')]
