...
class ArticleController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $data = array_merge($request->only(['user_id', 'title', 'slug', 'content', 'excerpt', 'status', 'published_at']), ['user_id' => Auth::id()]);
        $article = Article::create($data);

        return response()->json($article->load(['user']), Response::HTTP_CREATED);
    }
    ...
    public function update(Request $request, Article $article): JsonResponse
    {
        ...
        return response()->json($article->fresh()->load(['user']));
    }
